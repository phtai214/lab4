package com.example.loginfragment.fragment;
...
import com.example.loginfragment.ui.Utils;
...
public class InfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // user = null nghia la chua co user dang ky
        if(user == null){
            tvUserNameC.setText("khong co du lieu");
        }
        else {
